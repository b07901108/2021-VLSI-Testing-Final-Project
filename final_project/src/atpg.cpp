...
ATPG::ATPG()
{
    ...
    // **************************************************************************
    // Parameter  [ Atpg::this->backtrack_limit ]
    // Usage      [ set backtrack limit of decition tree ]
    // Date       [ Chi-Jhe Li Ver.1.0 2021/05/29 ]
    this->backtrack_limit = 50; /* this value can be changed */
    // **************************************************************************
...
ATPG::WIRE::WIRE()
{
    ...
    // **************************************************************************
    // Constructor[ Atpg::WIRE::WIRE() ]
    // Usage      [ new WIRE Class support SCOAP]
    // Date       [ Chi-Jhe Li Ver.1.0 2021/05/29 ]

    this->cc0 = 0;
    this->cc1 = 0;
    this->co = 2147483647; // max int
    // **************************************************************************
}
